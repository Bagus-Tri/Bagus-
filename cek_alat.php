...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE pengajuan_alat SET status='$status' WHERE id='$id'";
...
$sql = "SELECT * FROM pengajuan_alat";
...
<head>
    ...
    <title>Alat Rental Requests</title>
    <style>
        table {
            width: 100%;
